...
_LIB = str(Path(__file__).resolve().parent.parent)   # EMGOR_TD/RESOURCES/lib/
...
def load_all_models(face: bool = True):
    ...
    if not face:
        return dict(seg=seg, gest=gest, class_names=class_names, fd=None, fp=None, em=None)
